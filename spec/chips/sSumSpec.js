  ...
  it("behaves as expected", function () {
    ...
    var result = HDL.evaluate(describedChip, {
      ...
      b_sf1_5: _, b_sf1_4: _, b_sf1_3: _, b_sf1_2: _, b_sf1_1: T, b_sf1_0: _, // two           = 0
                                                                              // point         = 0
      b_sf2_3: _, b_sf2_2: T, b_sf2_1: T, b_sf2_0: T,                         // seven         = 1
      b_sf3_3: _, b_sf3_2: T, b_sf3_1: T, b_sf3_0: _,                         // six           = 1
                                                                              // percent       = 0
                                                                              // are b's       = 1
      ...
      f_sf1_5: _, f_sf1_4: _, f_sf1_3: _, f_sf1_2: T, f_sf1_1: T, f_sf1_0: _, // six           = 1
                                                                              // point         = 0
      ...
      g_sf1_5: _, g_sf1_4: _, g_sf1_3: _, g_sf1_2: T, g_sf1_1: T, g_sf1_0: T, // seven         = 1
                                                                              // point         = 0
      g_sf2_3: _, g_sf2_2: T, g_sf2_1: T, g_sf2_0: T,                         // seven         = 1
      g_sf3_3: _, g_sf3_2: T, g_sf3_1: T, g_sf3_0: _,                         // six           = 1
                                                                              // percent       = 0
                                                                              // are g's       = 1
      ...
      l_sf1_5: _, l_sf1_4: _, l_sf1_3: T, l_sf1_2: T, l_sf1_1: _, l_sf1_0: _, // twelve        = 0
                                                                              // point         = 0
      l_sf2_3: _, l_sf2_2: T, l_sf2_1: T, l_sf2_0: T,                         // seven         = 1
      l_sf3_3: _, l_sf3_2: T, l_sf3_1: T, l_sf3_0: _,                         // six           = 1
                                                                              // percent       = 0
                                                                              // are l's       = 1
      ...
      p_sf1_5: _, p_sf1_4: T, p_sf1_3: _, p_sf1_2: _, p_sf1_1: _, p_sf1_0: _, // sixteen       = 1
                                                                              // point         = 0
      ...
      q_sf1_5: _, q_sf1_4: T, q_sf1_3: _, q_sf1_2: _, q_sf1_1: _, q_sf1_0: T, // seventeen     = 1
                                                                              // point         = 0
      q_sf2_3: _, q_sf2_2: T, q_sf2_1: T, q_sf2_0: T,                         // seven         = 1
      q_sf3_3: _, q_sf3_2: T, q_sf3_1: T, q_sf3_0: _,                         // six           = 1
                                                                              // percent       = 0
                                                                              // are q's       = 1
      ...
      v_sf1_5: _, v_sf1_4: T, v_sf1_3: _, v_sf1_2: T, v_sf1_1: T, v_sf1_0: _, // twenty-two    = 0
                                                                              // point         = 0
      v_sf2_3: _, v_sf2_2: T, v_sf2_1: T, v_sf2_0: T,                         // seven         = 1
      v_sf3_3: _, v_sf3_2: T, v_sf3_1: T, v_sf3_0: _,                         // six           = 1
                                                                              // percent       = 0
                                                                              // are v's       = 1
    ...
    expect(result).toEqual({
      sum11: _, sum10: _, sum9: _, sum8: _, sum7: _, sum6: T,
      sum5: T, sum4: _, sum3: T, sum2: _, sum1: _, sum0: T
    });
  });
});
